# Graph Report - skyprints  (2026-07-12)

## Corpus Check
- 397 files · ~296,227 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3010 nodes · 8191 edges · 174 communities (144 shown, 30 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 1252 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a23ddb1`
...
Cohesion: 0.07
Nodes (26): LocationScopedUser, resolveLocationFilter(), RequestContext, RequestContextStore, ContextLogger, LOG_FILE, LOGS_DIR, RequestContextMiddleware (+18 more)
...
Cohesion: 0.11
Nodes (10): main(), generateFiscalCode(), getFiscalYear(), createOrder(), withUser(), createOrder(), withUser(), OrdersService (+2 more)
...
Cohesion: 0.08
Nodes (26): PrismaModule, Module, AnalyticsModule, Module, BillingModule, Module, CloudflareService, Injectable (+18 more)
...
- **Why does `RequestContextStore` connect `RequestContextStore` to `JwtAuthGuard`, `prisma.service.ts`, `AdminProcessService`, `runs.service.ts`, `BillingSnapshotService`, `.login`, `useAuth`, `auth.module.ts`, `ManagerQueueService`, `OrdersService`, `OrdersController`, `AnalyticsService`?**
