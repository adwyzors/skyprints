                                ...
                                customersData.customers.map((customer) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                            <span
                                                className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${customer.tax ? 'bg-blue-50 text-blue-700' : 'bg-gray-100 text-gray-500'
                                                    }`}
                                            >
                                                {customer.tax ? 'Yes' : 'No'}
                                            </span>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                            <span
                                                className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${customer.tds ? 'bg-blue-50 text-blue-700' : 'bg-gray-100 text-gray-500'
                                                    }`}
                                            >
                                                {customer.tds ? 'Yes' : 'No'}
                                            </span>
