...
export default function AdminLayout({
  ...
  const quickActions = [
    { label: "Create Order", icon: <Plus className="w-4 h-4" />, onClick: () => router.push("/admin/orders/new") },
    { label: "Generate Report", icon: <FileText className="w-4 h-4" />, onClick: () => console.log("Generate Report") },
    { label: "Schedule Production", icon: <Calendar className="w-4 h-4" />, onClick: () => console.log("Schedule Production") },
    { label: "Customer Onboarding", icon: <Users className="w-4 h-4" />, onClick: () => router.push("/admin/customers/new") },
  ];
