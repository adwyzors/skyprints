                            ...
                            <>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {/* CUSTOMER SELECTOR */}
                                        <div className="col-span-1 md:col-span-2 overflow-visible">
                                            <CustomerSelector
                                                customers={customers}
                                    ...
                                    {processRows.length === 0 ? (
                                        ...
                                        <div className="space-y-3 overflow-visible">
                                            {processRows.map((row, i) => (
                                                <div
                                                    key={i}
                                                    className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-gray-300 transition-colors overflow-visible"
                                                >
