            ...
            <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="bg-indigo-600 p-6 text-white text-center">
                    ...
                    <p className="text-indigo-100 text-sm mt-1">
                        Grouping {selectedOrders.length} orders
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="flex -space-x-2 overflow-hidden py-1">
                            {selectedOrders.slice(0, 5).map((order) => (
                                <div
                                    key={order.id}
                                    className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white border-2 border-white shadow-sm text-xs font-medium text-gray-600"
                                    title={order.code}
                                >
                                    {order.code.slice(0, 2)}
                                </div>
                            ))}
